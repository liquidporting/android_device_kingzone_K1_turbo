...
TARGET_BOOTLOADER_BOARD_NAME := K1_turbo
...
BOARD_CUSTOM_BOOTIMG_MK := device/kingzone/K1_turbo/mkbootimg.mk
...
# TWRP-Specific
TARGET_RECOVERY_FSTAB := device/kingzone/K1_turbo/recovery/root/etc/twrp.fstab
